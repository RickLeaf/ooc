...
.dlls,e674 .dlls: mutex.pe674

-include package/cfg/mutex_pe674.mak
-include package/cfg/mutex_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mutex_pe674.dep
endif
mutex.pe674: package/cfg/mutex_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
mutex.pe674 package/cfg/mutex_pe674.c: .libraries,e674
endif

package/cfg/mutex_pe674.c package/cfg/mutex_pe674.h package/cfg/mutex_pe674.xdl: override _PROG_NAME := mutex.xe674
package/cfg/mutex_pe674.c: package/cfg/mutex_pe674.cfg

clean:: clean,e674
	-$(RM) package/cfg/mutex_pe674.cfg
	-$(RM) package/cfg/mutex_pe674.dep
	-$(RM) package/cfg/mutex_pe674.c
	-$(RM) package/cfg/mutex_pe674.xdc.inc

clean,e674::
	-$(RM) mutex.pe674
.executables,e674 .executables: mutex.xe674

mutex.xe674: |mutex.pe674

-include package/cfg/mutex.xe674.mak
mutex.xe674: package/cfg/mutex_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/mutex_pe674.oe674   package/cfg/mutex_pe674.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
mutex.xe674: export C_DIR=
mutex.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
mutex.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

mutex.test test,e674 test: mutex.xe674.test

mutex.xe674.test:: mutex.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mutex.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mutex.xe674, ) 
endif

clean,e674::
	-$(RM) .tmp,mutex.xe674,0,*
...
clean,e674::
	-$(RM) mutex.xe674
clean:: 
	-$(RM) package/cfg/mutex_pe674.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
mutex_pe674.oe674,copy : package/cfg/mutex_pe674.oe674
mutex_pe674.se674,copy : package/cfg/mutex_pe674.se674
...
package/rel/xconfig_mutex/xconfig_mutex/package/package.rel.xml: .force
